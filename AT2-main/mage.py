...
class Mage(Character):
    ...
    def freeze(self, target):
        ...
        self.current_attack_message = str(f"{self.name} Freezes {target.name} for {damage} damage!")
    ...
    def brarade(self, target):
        ...
        self.current_attack_message = str(f"{self.name} Bararades {target.name} for {damage} damage!")
    ...
    def shock(self, target):
        ...
        target.take_damage(damage)
        self.current_attack_message = str(f"{self.name} dealt a total of {total_damage} damage with Shock!")
    ...
    def fusion_grenade(self, target):
        ...
        target.take_damage(damage)
        self.current_attack_message = str(f"{self.name} Throws a Fusion Grenade on {target.name} for {damage} damage!")

    def whimsical_posture(self, target):
        self.armor_class += 5  # Example: Defensive stance increases armor class by 5
        self.current_attack_message = str(f"{self.name} takes up a Whimsical Posture increasing their armor!")
